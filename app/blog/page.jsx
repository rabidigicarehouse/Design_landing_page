        ...
        <div className="container mx-auto">
          ...
          <div className="mb-20 max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-primary">Insight Collective</span>
            </motion.div>
            ...
            >
              The <span className="text-primary italic">Brain</span> <br className="hidden sm:block" /> 
            ...
            >
              Exploring the intersections of brand psychology, artificial intelligence, and cutting-edge digital architecture.
            </motion.p>
          </div>
