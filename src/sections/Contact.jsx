...
const Contact = () => {
  ...
  return (
    <section ref={container} className="section section-theme-violet relative overflow-hidden pt-28 pb-20 sm:pt-28 sm:pb-24 lg:pt-[9.2rem] lg:pb-[4.8rem] xl:pt-[10rem] xl:pb-[5.2rem] 2xl:pt-36 2xl:pb-28" id="contact">
