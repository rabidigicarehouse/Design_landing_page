...
const Contact = () => {
  ...
  return (
    <section ref={container} className="section section-theme-violet relative box-border flex min-h-screen items-center overflow-hidden pb-16 pt-[140px] sm:pb-20 lg:pb-24 lg:pt-[160px] xl:pb-24 xl:pt-[180px] 2xl:pb-28 2xl:pt-[190px]" id="contact">
