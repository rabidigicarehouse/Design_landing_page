...
const PackageCTA = () => {
  return (
    <section className="section section-theme-violet flex min-h-screen items-center overflow-hidden pb-6 pt-[80px] sm:pb-16 sm:pt-[120px] lg:pb-20 lg:pt-[160px] xl:pb-24 xl:pt-[180px] 2xl:pb-24 2xl:pt-[190px]" id="packages">
