         ...
         <div className="relative max-w-7xl mx-auto">
            <AnimatePresence mode="wait" custom={direction}>
               ...
               >
                  ...
                  <div className="w-full lg:w-[61%] xl:w-[59%] 2xl:w-[56%] flex min-h-[400px] lg:min-h-[332px] xl:min-h-[350px] 2xl:min-h-[500px] flex-col items-center lg:items-start text-center lg:text-left">
                     ...
                     <h2 className={`mx-auto mb-2 w-full max-w-[15.5ch] px-5 text-center font-black font-heading tracking-tighter uppercase italic leading-[0.86] text-slate-950 dark:text-white lg:mx-0 lg:max-w-[18.2ch] xl:max-w-[18.9ch] 2xl:max-w-[18ch] lg:px-0 lg:text-left ${protocolTitleClass}`}>
                        The {displayTitle} <span className="text-gradient">{headlineSuffix}.</span>
                     </h2>
                     
                     <p className="mb-4 min-h-[94px] text-xl md:min-h-[120px] md:text-2xl lg:min-h-[62px] lg:text-[0.82rem] xl:min-h-[72px] xl:text-[0.94rem] 2xl:min-h-[120px] 2xl:text-2xl dark:text-gray-400 text-slate-600 font-light leading-relaxed tracking-tight max-w-xl">
                        {activeService.desc}
                     </p>
                     ...
                     <div className="mt-auto pt-1 sm:pt-4 w-full flex justify-center overflow-visible">
                        <div className="grid w-full max-w-[22rem] sm:max-w-none grid-cols-[auto_1fr_auto] items-center justify-center gap-3 sm:flex sm:items-center sm:justify-center sm:gap-4 lg:gap-1.5 xl:gap-2.5 2xl:gap-8 px-2 sm:px-0">
