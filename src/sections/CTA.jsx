    ...
    <section className="section overflow-hidden bg-slate-50 dark:bg-dark-bg" id="cta">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <motion.div
           ...
           viewport={{ once: true }}
           className="p-12 md:p-16 rounded-[3rem] border border-slate-200 dark:border-white/5 relative overflow-hidden shadow-2xl bg-white dark:bg-[#0c0c1d]"
        >
          {/* Inner glow effect */}
          ...
          <div className="relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full dark:bg-white/[0.05] bg-black/[0.05] border dark:border-white/10 border-black/10 mb-8"
            >
              <MessageSquare className="w-4 h-4 text-primary" />
              <span className="text-sm font-medium tracking-wide uppercase dark:text-gray-300 text-slate-700">Ready to build?</span>
            </motion.div>

            <h2 className="text-4xl md:text-6xl font-black tracking-tight dark:text-white text-slate-950 mb-6 font-heading">
              Let's create something <br />
              <span className="text-gradient">extraordinary.</span>
            </h2>
            
            <p className="text-xl dark:text-gray-400 text-slate-600 max-w-2xl mx-auto mb-12 font-light">
            ...
            <a href="#contact" onClick={(e) => handleScrollTo(e, '#contact')} className="w-full md:w-auto inline-block">
              <Button variant="primary" className="text-lg px-10 py-5 rounded-full shadow-2xl shadow-primary/40 hover:scale-105 group w-full md:w-auto">
                Connect Us 
