...
const CustomCursor = () => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[9999] hidden lg:block">
      <motion.div
        className="absolute h-16 w-16 rounded-full border border-primary/50 bg-[radial-gradient(circle,rgba(255,255,255,0.22),rgba(255,255,255,0.03)_45%,rgba(124,58,237,0.04)_80%)] shadow-[0_0_35px_rgba(124,58,237,0.22)] backdrop-blur-[2px]"
      ...
      />
      <motion.div
        className="absolute flex h-10 w-10 items-center justify-center rounded-full bg-primary shadow-[0_0_22px_rgba(124,58,237,0.7)]"
      ...
      <motion.div
        ...
        animate={{
          rotate: 0,
          scale: hoverType === 'default' ? 0.8 : 0.5,
