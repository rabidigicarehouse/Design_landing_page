      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            data-lenis-prevent="true"
            data-lenis-prevent-touch="true"
            className="relative z-[10001] mt-2 flex w-full max-w-[1080px] xl:max-w-[1160px] flex-col overflow-visible rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-[0_0_100px_rgba(0,0,0,0.5)] dark:border-white/10 dark:bg-[#0c0c1d] sm:mt-0 sm:p-5 md:rounded-[2.5rem] md:p-8 lg:rounded-[2.75rem] lg:p-6 xl:rounded-[4rem] xl:p-12"
